...
import { useGetPosts, useSearchPosts } from "@/lib/react-query/queiresAndMutations";
...
const Explore = () => {
  ...
  const shouldShowPosts = !shouldShow && posts?.pages?.every((item) => item?.documents.length === 0)
